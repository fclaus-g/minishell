...
ctrl-D in a prompt after you wrote some stuff should not do anything. ctrl-\ in a prompt after you wrote some stuff should not do anything.
...
[from Users/pgomez-r/github/minishell/] ../../../../bin/usr/bin/wc -c "hola"
